...
public class alanWalkerPlay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alan_walker_play);

        // sets this instance to a specific song
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.alan_walker_fade);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mainIntent = new Intent(alanWalkerPlay.this, MainActivity.class);
        ...
        moreInformations.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent moreInfointent = new Intent(alanWalkerPlay.this, alanWalkerInfo.class);
